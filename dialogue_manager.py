...
class ThreadRanker(object):
    ...
    def get_best_thread(self, question, tag_name):
        ...
        best_thread = pairwise_distances_argmin([question_vec], thread_embeddings, axis=1, metric="cosine")
...
class DialogueManager(object):
    ...
    def create_chitchat_bot(self):
        ...
        self.chitchat_bot = ChatBot('Gamma', 
    ...
    def generate_answer(self, question):
        ...
        # Goal-oriented part:
            ...
            thread_id = self.thread_ranker.get_best_thread(prepared_question, tag[0])[0] 
